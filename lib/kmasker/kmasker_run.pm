...
sub run_kmasker_MK{
	...
	move("$temp_path/KMASKER_comparative_FC".$fold_change."_$tab1" . "_regions_merged".".gff " , $gffname_D1);
    move("$temp_path/KMASKER_comparative_FC".$fold_change."_$tab2" . "_regions_merged".".gff " , $gffname_D2);
