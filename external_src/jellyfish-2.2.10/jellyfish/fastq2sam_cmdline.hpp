...
#ifndef __FASTQ2SAM_CMDLINE_HPP__
#define __FASTQ2SAM_CMDLINE_HPP__
...
public:
  ::std::vector<string>          fastq_arg;
  typedef ::std::vector<string>::iterator fastq_arg_it;
  typedef ::std::vector<string>::const_iterator fastq_arg_const_it;
  ...
  fastq2sam_cmdline(int argc, char* argv[]) :
    fastq_arg()
  { parse(argc, argv); }
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    ...
    for( ; optind < argc; ++optind) {
      fastq_arg.push_back(string(argv[optind]));
    }
  }
  static const char * usage() { return "Usage: fastq2sam [options] fastq:string+"; }
  class error {
    int code_;
  ...
  static const char * help() { return
    "Convert a fastq file to a bare SAM file\n\n"
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void dump(::std::ostream &os = std::cout) {
    os << "fastq_arg:" << vec_str(fastq_arg) << "\n";
  }
};
#endif // __FASTQ2SAM_CMDLINE_HPP__"
